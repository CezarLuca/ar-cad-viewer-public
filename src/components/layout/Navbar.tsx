            ...
            <header
                className={
                    isHomePage || isTrackerPage
                        ? `fixed top-0 left-0 right-0 h-18 sm:h-14 bg-gray-100/80 dark:bg-gray-900/80 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between px-4 sm:px-6 z-50`
                        : `fixed top-0 left-0 right-0 h-14 bg-gray-100/80 dark:bg-gray-900/80 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between px-4 sm:px-6 z-50`
                }
            >
